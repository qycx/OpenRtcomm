...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "qyMessengerApp.Android.dll" comes first in this list. */
		...
		"EasyPermissions.Xamarin.Android.dll",
		"FormsViewGroup.dll",
		...
		"qyMessengerApp.Android.dll",
		"LeakCanary.Analyzer.dll",
		"LeakCanary.dll",
		"LeakCanary.Watcher.dll",
		"myBindingClassLibrary.dll",
		"myBindingClassLibrary_ffmpeg.dll",
		"myBindingClassLibrary_gles.dll",
		"myBindingClassLibrary_tmpJavaLib.dll",
		"qyMessengerApp.dll",
	};
