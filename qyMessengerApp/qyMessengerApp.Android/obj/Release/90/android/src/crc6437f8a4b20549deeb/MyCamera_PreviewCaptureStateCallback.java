...
public class MyCamera_PreviewCaptureStateCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("qy.Droid.MyCamera+PreviewCaptureStateCallback, qyMessengerApp.Android", MyCamera_PreviewCaptureStateCallback.class, __md_methods);
	}


	public MyCamera_PreviewCaptureStateCallback ()
	{
		super ();
		if (getClass () == MyCamera_PreviewCaptureStateCallback.class)
			mono.android.TypeManager.Activate ("qy.Droid.MyCamera+PreviewCaptureStateCallback, qyMessengerApp.Android", "", this, new java.lang.Object[] {  });
	}
