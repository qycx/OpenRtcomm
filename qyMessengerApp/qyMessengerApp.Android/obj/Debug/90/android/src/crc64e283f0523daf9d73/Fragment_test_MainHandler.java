...
/** @hide */
	...
	public Fragment_test_MainHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == Fragment_test_MainHandler.class)
			mono.android.TypeManager.Activate ("qyMessengerApp.Droid.Fragment_test+MainHandler, qyMessengerApp.Android", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public Fragment_test_MainHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == Fragment_test_MainHandler.class)
			mono.android.TypeManager.Activate ("qyMessengerApp.Droid.Fragment_test+MainHandler, qyMessengerApp.Android", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
