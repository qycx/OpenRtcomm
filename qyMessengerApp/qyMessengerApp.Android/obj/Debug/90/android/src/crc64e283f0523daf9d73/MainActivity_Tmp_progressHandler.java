...
/** @hide */
	...
	public MainActivity_Tmp_progressHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == MainActivity_Tmp_progressHandler.class)
			mono.android.TypeManager.Activate ("qyMessengerApp.Droid.MainActivity+Tmp_progressHandler, qyMessengerApp.Android", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public MainActivity_Tmp_progressHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == MainActivity_Tmp_progressHandler.class)
			mono.android.TypeManager.Activate ("qyMessengerApp.Droid.MainActivity+Tmp_progressHandler, qyMessengerApp.Android", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
