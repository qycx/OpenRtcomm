...
/** @hide */
	...
	public camera_RenderThread_camera_RenderHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == camera_RenderThread_camera_RenderHandler.class)
			mono.android.TypeManager.Activate ("qyMessengerApp.Droid.camera_RenderThread+camera_RenderHandler, qyMessengerApp.Android", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public camera_RenderThread_camera_RenderHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == camera_RenderThread_camera_RenderHandler.class)
			mono.android.TypeManager.Activate ("qyMessengerApp.Droid.camera_RenderThread+camera_RenderHandler, qyMessengerApp.Android", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
