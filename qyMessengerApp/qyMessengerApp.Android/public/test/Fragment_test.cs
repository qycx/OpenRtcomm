...
{
    public class Fragment_test : Fragment, TextureView.ISurfaceTextureListener, SeekBar.IOnSeekBarChangeListener
    {
...
public void sendRedraw()
{
    ...
    switch (what)
    {
        ...
        {
            //
            qyFuncs.showInfo_open(0, null, "fg_test.doClean_ifActivityIsFinished enters");
            ...
            //
            qyFuncs.showInfo_open(0, null, "fg_test.doClean_ifActivityIsFinished leaves");
