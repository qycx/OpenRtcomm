...
#if  10
	float  res0  =  abs(  h_p  +  1  -  h_key  );		//  abs(  h1  +  1  -  h2  );
	float  res1  =  abs(  h_p  -  h_key  );			//  abs(  h1  -  h2  );
	float  res2  =  abs(  h_p  -  1  -  h_key  );		//  abs(  h1  -  1  -  h2  );
 ...
 MY_float4  hlsl_rgbToHsl_f( float  r,  float g,  float b,  float  a )
{
	...
	else 
	{
		...
		if  (  abs(  tmp_m  )  <  0.00001  )  tmp_m  =  0.00001;
		s  =  d  /  tmp_m;
		
		float  tmp_d;
		tmp_d  =  d;
		if  (  abs(  tmp_d  )  <  0.00001  )  tmp_d  =  0.00001;
