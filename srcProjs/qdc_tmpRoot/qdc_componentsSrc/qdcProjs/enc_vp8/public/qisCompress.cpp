...
//
#define	CONST_ver_qisCompress		"026132"	//	2014/05/13,"025982";		// 2014/02/27,"02592301";		//  2013/03/06,"02550501";  2012/11/12
 ...
 extern  "C"  __declspec(  dllexport  )  int  qdcInit(  QDC_MGR  *  p  )
{
	...
	//
	p->iCompressorId  =  1;
	_tcsncpy(  p->name,  _T(  "enc_vp8"  ),  sizeof(  p->name  )  /  sizeof(  p->name[0]  )  );
	//  2014/12/02
