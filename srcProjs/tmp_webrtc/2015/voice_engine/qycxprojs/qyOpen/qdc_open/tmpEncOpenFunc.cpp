 ...
 extern  "C"  int  tmpEnc_setFuncs(  QDC_OBJ_INFO  *  pQdcObjInfo  )
{
	...
	if  (  !pQdcObjInfo->pf_qoi_getPtrProperty  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, qoi_getPtr is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_ENC_d3d11_devVar_new  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_ENC_d3d11_devVar_new is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_ENC_d3d11_devVar_free  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_ENC_d3d11_devVar_free is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_encDev_YUVReader_myLoadNextFrame  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_encDev_YUVReader_myLoadNextFrame is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_preForTest_encDev_YUVReader_myLoadNextFrame  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_preForTest_encDev_YUVReader_myLoadNextFrame is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_getSize_QIS_chromaKey_effect  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_getSize_QIS_chromaKey_effect is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_initQisChromaKeyEffect  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_initQisChromaKeyEffect is null"  )  );
		return  -1;
	}
	...
	if  (  !g_pf_exitQisChromaKeyEffect  )  {
		tmp_showInfo(  _T(  "qdcInitEncV failed, g_pf_exitQisChromaKeyEffect is null"  )  );
		return  -1;
	}
