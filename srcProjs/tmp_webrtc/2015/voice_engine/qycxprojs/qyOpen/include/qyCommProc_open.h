...
//  2014/03/29
#if  0
#define		CONST_msdk_auto											0												//  2014/03/29
#define		CONST_msdk_software										1
#define		CONST_msdk_hardware										2
#define		DEFAULT_msdk_hardwareAccl								CONST_msdk_auto			
#endif
...
//
typedef  int  (  *PF_parseDecAPkt_o  )(  void  *  pPktParam,  void  **  ppAh,  unsigned  char  **  ppOutput,  unsigned  int  *puiSize  );
...
//  2015/10/29
typedef  int  (  *PF_myLoadNextFrame  )(  unsigned  short  usPktResType,  void  *  p0_pInput,  void  *  p1_uiInputSize,  void  *  p2_myLoadNextFrame  );		


//
typedef  int  (  *PF_smplPCMReader_LoadNextFrame  )(  void  *  pQdcObjInfoParam,  long  *  pold_lPktId,  PF_myLoadNextFrame  pf_myLoadNextFrame,  void  *  p2_myLoadNextFrame,  BOOL  *  pbNeed_forceKeyFrame  );

//  2014/07/08
//  typedef  int  (  *PF_smplYUVReader_LoadNextFrame  )(  void  *  pQdcObjInfoParam,  long  *  pold_lPktId,  PF_commonHandler  pf_myLoadNextFrame,  void  *  p2_myLoadNextFrame,  BOOL  *  pbNeed_forceKeyFrame  );
...
//  #define		CONST_uiTransformType_decVideo				2
#define		CONST_uiTransformType_dec					2
//
#define		CONST_uiTransformType_encAudio				3
//#define		CONST_uiTransformType_decAudio				4
...
typedef  struct  __videoInputInfo_t								{
				 ...
				 unsigned  short								usFramesThisSecond;											//  2011/08/30
...
void  mySaveYv12(  LPCTSTR  szFilename,  int  w,  int  h,  void  *  yv12,  BOOL  bFlipImg  );
