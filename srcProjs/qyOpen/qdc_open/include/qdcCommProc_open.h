...
typedef  struct  __qdcObjInfo_varCommon_t							{
				 ...
				 struct												{
						 ...
						 //
						 DWORD										dwLastTickCnt_insertKeyFrame1;
...
//
//#define		QDC_OBJ_hdDec			QDC_OBJ_trans
...
//
//
typedef  struct  __pkts_sharedTexInfo_forYuvWriter1_t				{
				 //  2015/09/29
				 PKT_sharedTex_info1								mems[MAX_pkts_sharedTexInfo_forYuvWriter];
				 unsigned  char										ucCnt;
}		 PKTS_sharedTexInfo_forYuvWriter1;
...
typedef  struct {
	...
	struct {
		...
		unsigned  short											usPktResType;
		//PKT_sharedTex_info										pktSharedTexInfo;
		PKTS_sharedTexInfo_forYuvWriter1						pkts_sharedTexInfo;
...
//
#define		CONST_qdcPropId_bWin7														10
#define		CONST_qdcPropId_bWinService													11

//
#define		CONST_qdcPropId_bShowDec_sharedTexStatus									100			//  2016/04/09
#define		CONST_qdcPropId_uiXql_player												101			//  2016/04/14
//
#define		CONST_qdcPropId_dbgName														105
#define		CONST_qdcPropId_pbMon														106			//  2023/04/23
//
#define		CONST_adcPropId_videoHeader													107			//  2026/01/10
//
#define		CONST_adcPropId_getModuleInfo												108
...
#define		CONST_qdcPropId_PF_saveTex12												270

#define		CONST_qdcPropId_pQisSharedTexInfos											273			//  2023/12/02
...
//
#define		CONST_qdcPropId_chkNv														290			//  2024/11/14
...
//
typedef  struct  __param_getModuleInfo_t				{
...
//  2017/10/12
typedef  struct  __param_bSupport_sharedTex_dec_t		{
				 int									iType;
				 int									iFourcc;
}		 PARAM_bSupport_sharedTex_dec;

//  201
typedef  struct  __param_bSupport_sharedTex_enc_t		{
				 int									iType;
				 int									iFourcc;
}		 PARAM_bSupport_sharedTex_enc;

//
typedef  struct  __param_chkNv_o_t {
				 bool									bOk;
}		 PARAM_chkNv_o;
...
typedef  int  (*PF_qdcDecompressAudio)(QDC_OBJ_INFO* pQdcObjInfo, QY_AUDIO_HEADER* pAh_compress, BYTE* pInput, unsigned  int  uiInputLen, int  iSampleTimeInMs, unsigned  int  uiPts);
//  2025/11/15. 将最后一个参数改成pts
...
//  2017/10/10
typedef  int  (  *PF_qdcGetSpsPps  )(  QDC_OBJ_INFO  *  pQdcObjInfo,  char  *  spsBuf,  unsigned  int  *  puiSpsSize,  char  *  ppsBuf,  unsigned  int  *  puiPpsSize,  char  *  vps,  unsigned  int  *  puiVpsSize  );
