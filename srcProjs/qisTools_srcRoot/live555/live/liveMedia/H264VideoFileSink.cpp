...
::H264VideoFileSink(UsageEnvironment& env, FILE* fid,
    ...
    unsigned bufferSize, char const* perFrameFileNamePrefix)
    : H264or5VideoFileSink(env, fid, bufferSize, perFrameFileNamePrefix,
        sPropParameterSetsStr1, sPropParameterSetsStr2, sPropParameterSetsStr3) {
}
...
H264VideoFileSink::createNew(UsageEnvironment& env, char const* fileName,
    ...
    do {
        ...
        return new H264VideoFileSink(env, fid, sPropParameterSetsStr1, sPropParameterSetsStr2, sPropParameterSetsStr3, bufferSize, perFrameFileNamePrefix);
    } while (0);
