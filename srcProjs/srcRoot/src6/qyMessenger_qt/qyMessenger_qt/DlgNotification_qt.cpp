...
__declspec(dllexport)  int  popupNotificationWnd()
{
	...
	int  iWndContentType; iWndContentType = 0;
	unsigned  int  uiInitW; uiInitW = pProcInfo->cfg.policy.notification.iW_pic;
	unsigned  int  uiInitH; uiInitH = pProcInfo->cfg.policy.notification.iH_pic;
