...
void SearchMsgRecord::slot_list_item_clicked(QModelIndex idx) {
    ...
    QStringList strList = msg_id.split("_", QString::SkipEmptyParts);
...
void SearchMsgRecord::setContent(QString idInfo, QString keyword)
{
    ...
    getTalkerDesc(idInfo_s, &uiObjType, grpName_peer, mycountof(grpName_peer), null, null, 0, null, 0, srcName_peer, mycountof(srcName_peer));
