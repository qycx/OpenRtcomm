			...
			case  ID_startAvCall:		{
				  ...
				  if (0) {
					  ...
					  if (10) {
						  ...
						  //
						  param.talkerPolicy.conf_bitrateInKbps_dl = 40;
						  param.talkerPolicy.conf_bitrateInKbps_ul = 40;
				  ...
				  //
				  showInfo_open(0, 0, 0, _T("after doCmd_startAvCall.l6157"));
						  ...
						  //
				{
					...
					if  (  !IsWindow(  pShadowMgr->bgWall.hBgWall  )  )  {
						  ...
						  if  (  IsWindow(  hWall  )  )  {
							  ...
							  //
							  timestamp_renew(   NULL,  &pTalkerDataCfg->ts_layout,_T("dlgTalk_OnIsCmd_noSyunc.l6183"));
