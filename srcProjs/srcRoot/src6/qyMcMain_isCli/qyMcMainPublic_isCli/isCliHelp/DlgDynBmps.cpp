 ...
 int  CDlgDynBmps::refreshWallBySp(  int  spIndex  )
{
	...
	for  (  pQNode  =  pSp->pSpObjQ->front.pNext;  pQNode  &&  pQNode->qElemMemory.m_pBuf  &&  nZones  <  mycountof(  pSubWall->mems  );  pQNode  =  pQNode->pNext  )  {
		 ...
		 if  (  pSpObj->type  ==  SP_RECTANGLE_TYPE  )  {
			 ...
			 {
				 old_freeCapImages(  this->m_hWnd,  pSubWall->idc,  &pZone->images,  pSubWall->hWnd_dst,  NULL,  _T(  "refreshWallBySp.1551"  ));
	...
	for  (  i  =  nZones;  i  <  pSubWall->usCnt;  i  ++  )  {
		 ...
		 old_freeCapImages(  this->m_hWnd,  pSubWall->idc,  &pZone->images,  pSubWall->hWnd_dst,  NULL,  _T(  "refreshWallBySp.1571"  ));
	}
 ...
 int  CDlgDynBmps::refreshWallByRules(  int  spIndex  )
{
	...
	for  (  i  =  0;  i  <  pSubWall->usCnt;  i  ++  )  {
		 ...
		 //
		 old_freeCapImages(  this->m_hWnd,  pSubWall->idc,  &pZone->images,  pSubWall->hWnd_dst,  NULL,  _T(  "refreshWallByRules.1626"  ));
	}
	...
	for  (  i  =  0;  i  <  pSubWall->usCnt;  i  ++  )  {
		 ...
		 switch  (  pZone->rule.common.uiType  )  {
				 case  CONST_vwRuleType_dynBmp:
					   ...
					   getTalkerDesc(  pZone->rule.dynBmp.ruleDynBmp.dynBmp.idInfo,  tBuf,  mycountof(  tBuf  ),  NULL,  0  );
					   break;
				 default:
						break;
		 }
		 ...
		 //  2017/10/31
		 timestamp_renew(  0,  &pZone->ts_zone,_T("dlgDynBmps.refreshWallByRules.l1671"));
...
int  CDlgDynBmps::restoreSpRules(  )
{
	...
	for  (  vector<VW_ruleU>::const_iterator it =csVector_rules.begin(); it < csVector_rules.end(); ++ it,  kk  ++  )  {
		...
		for  (  pQNode  =  pSp->pSpObjQ->front.pNext;  pQNode  &&  pQNode->qElemMemory.m_pBuf;  pQNode  =  pQNode->pNext  )  {
			 ...
			 //
			 if  (  qPostMsg(  &tmpRule,  sizeof(  tmpRule  ),  pSubWall->pRuleQ,  _T(  "restoreSpRules"  )))  goto  errLabel;
			 //
			 break;
		}
...
int  CDlgDynBmps::doAutoLayout_talker(  )
{
	...
	for  (  j  =  0;  j  <  iRows;  j  ++  )  {
		//
		 ...
		 for  (  i  =  0;  i  <  iRows;  i  ++  )  {
			 ...
			 //			
			 if  (  qPostMsg(  &rule,  sizeof(  rule  ),  pSubWall->pRuleQ,  _T(  "doAutoLayout_talker"  )))  goto  errLabel;
	...
	for  (  j  =  0;  j  <  iRows;  j  ++  )  {
		//
		 ...
		 for  (  i  =  0;  i  <  iRows;  i  ++  )  {
			 ...
			 rule.bgMemVideo.idInfo.ui64Id  =  pShadowMgr->confCtrl.grpConfCtrl.pMems[index].idInfo.ui64Id;
			 //			
			 if  (  qPostMsg(  &rule,  sizeof(  rule  ),  pSubWall->pRuleQ,  _T(  "doAutoLayout_talker 1")))  goto  errLabel;
	...
	for  (  j  =  0;  j  <  iRows;  j  ++  )  {
		 ...
		 for  (  i  =  0;  i  <  iRows;  i  ++  )  {
			 ...
			 rule.bgMemVideo.idInfo.ui64Id  =  pShadowMgr->confCtrl.grpConfCtrl.pMems[index].idInfo.ui64Id;
			 //			
			 if  (  qPostMsg(  &rule,  sizeof(  rule  ),  pSubWall->pRuleQ,  _T(  "doAutoLayout_talker 2"  )))  goto  errLabel;
...
int  CDlgDynBmps::tryToSetRule(  POINT  screenPoint,  LPCTSTR  dropStr  )
{
	...
	{		//  2011/11/19
								...
								//
								if  (  qPostMsg(  &rule,  sizeof(  rule  ),  m_var.pWall->getCurSubWall(  )->pRuleQ,  _T(  "tryToSetRule"  )))  goto  errLabel;
 ...
 int  addZone_talkers(  HWND  hDlgWalls,  BOOL  bFullWall,  int  iX,  int  iY,  unsigned  int  iW,  unsigned  int  iH  )
{
	...
	if  (  qPostMsg(  &rule,  sizeof(  rule  ),  pSubWall->pRuleQ,  _T(  "addZone_talkers"  )))  goto  errLabel;
...
BOOL CDlgDynBmps::OnInitDialog()
{
	...
	if  (  bNeedNewRect  )  
	{
		...
		if  (  qPostMsg(  &rule,  sizeof(  rule  ),  pSubWall->pRuleQ,  _T(  "dlgDynBmps.OnInitDialog"  )))  goto  errLabel;
	    ...
	    //  bUseDxSurface  =  FALSE;
					  ...
					  if  (  iWndContentType  ==  CONST_qyWndContentType_vWall  )  {
						  ...
						  if  (  iWndContentSubtype  ==  CONST_vwSubtype_qvcf  )  {
							  ...
							  if  (  drawCapImages(  pQyMc,  old_M_GetDlgItem(  this->m_hWnd,  (  int  )pSubWall->idc  ),  m_var.ucbAutoClip,  pMsg,  pZone->iX,  pZone->iY,  pZone->iW,  pZone->iH,  NULL,  NULL,  &pZone->images,  pSubWall->hWnd_dst,  &pSubWall->hDc_dst,  NULL  )  )  goto  errLabel;
						  ...
						  //
							...
							if  (  !bZoneOk  )  {
								...
								if  (  pZone->rule.common.uiType  ==  CONST_vwRuleType_bgMemVideo  )  {
									old_freeCapImages(  m_hWnd,  pSubWall->idc,  &pZone->images,  pSubWall->hWnd_dst,  NULL,  _T(  "dlgDynBmps.OnQyComm.4112"  ));
								}
							...
							pSubWall->hWnd_dst  =  m_hWnd;
							if  (  drawCapImages(  pQyMc,  old_M_GetDlgItem(  this->m_hWnd,  (  int  )pSubWall->idc  ),  m_var.ucbAutoClip,  pMsg,  pZone->iX,  pZone->iY,  pZone->iW,  pZone->iH,  NULL,  pZoneParam,  &pZone->images,  pSubWall->hWnd_dst,  &pSubWall->hDc_dst,  NULL  )  )  goto  errLabel;
				  }
#if  0  //  2016/12/27
			...
			case  CONST_qyWmParam_freeCapImage:	//  2010/09/12
				  ...
				  for  (  i  =  0;  i  <  m_var.pWall->m_var.usCnt;  i  ++  )  {
					  ...
					  for  (  j  =  0;  j  <  pSubWall->usCnt;  j  ++  )  {
						  old_freeCapImageBySth(  pCqt,  m_hWnd,  pSubWall->idc,  pComm->u.freeCapImage.iTaskId,  &idInfo,  &pSubWall->mems[j].images,  pSubWall->hWnd_dst  );
					  }
				  }
				  break;
			...
			for  (  i  =  0;  i  <  m_var.pWall->m_var.usCnt;  i  ++  )  {
				 ...
				 for  (  j  =  0;  j  <  pSubWall->usCnt;  j  ++  )  {
					  for  (  k  =  0;  k  <  mycountof(  pSubWall->mems[j].images.mems  );  k  ++  )  {
						   ...
						   old_freeCapImageByTaskId(  this->m_hWnd,  (  int  )pSubWall->idc,  pImg->iTaskId,  &pSubWall->mems[j].images,  pSubWall->hWnd_dst  );
				  ...
				  switch  (  uCmd  )  {
						  case  ID_qySetDynBmp:  {
								...
								*/
								...
								//
								if  (  qPostMsg(  &rule,  sizeof(  rule  ),  m_var.pWall->getCurSubWall(  )->pRuleQ,  _T(  "dlgDynBmps.OnContextMenu"  )))  goto  errLabel;
						  ...
						  case  ID_setMessengerBmp:{		//  2011/11/19
								...
								//
								if  (  qPostMsg(  &rule,  sizeof(  rule  ),  m_var.pWall->getCurSubWall(  )->pRuleQ,  _T(  "dlgDynBmps.oncontextMenu 1")))  goto  errLabel;
						  ...
						  case  ID_qySetImGrpMemBmp:  {
								...
								//
								if  (  qPostMsg(  &rule,  sizeof(  rule  ),  m_var.pWall->getCurSubWall(  )->pRuleQ,  _T(  "dlgDynBmps.oncontextMenu 2"  )))  goto  errLabel;
						  ...
						  case  ID_selectMessenger:	{		//  2012/04/22
								...
								//
								if  (  qPostMsg(  &rule,  sizeof(  rule  ),  m_var.pWall->getCurSubWall(  )->pRuleQ,  _T(  "dlgDynBmps.oncontextMenu 3"  )))  goto  errLabel;
						  ...
						  case  ID_setZone_walls:  {  
								...
								//
								if  (  qPostMsg(  &rule,  sizeof(  rule  ),  m_var.pWall->getCurSubWall(  )->pRuleQ,  _T(  "dlgDynBmps.oncontextMenu 5"  )))  goto  errLabel;
	...
	switch  (  iMenuId  )  {
			...
			case  ID_selectContact:  {
				  ...
				  if  (  !showDlgObjs(  pQyMc->g_hInst,  m_hWnd,  &param  )  )  {
					  ...
					  HWND  hVWall  =  m_hWnd;
					  int  iWndContentType  =  getWndContentType(  );
					  pFuncs->pf_tryToTalkToMessenger_id(  mynull,param.o.ui64Id_selected,  0,  TRUE,  hVWall,  iWndContentType,  NULL  );					 
				  }
				  }
				  break;
			case  ID_selectGroup:  {
...
void CDlgDynBmps::OnWindowPosChanged(WINDOWPOS* lpwndpos)
{
	...
	if  (  pProcInfo->g_hVWall  ==  m_hWnd  )  {
		...
		if  (  pFuncs->pf_bMainWndAbove(  pProcInfo->pQyMc,pProcInfo->g_hVWall  )  )  {
