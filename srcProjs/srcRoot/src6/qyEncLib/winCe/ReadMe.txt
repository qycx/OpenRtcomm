========================================================================
    STATIC LIBRARY : qyEncLib_winCe Project Overview
========================================================================

AppWizard has created this qyEncLib_winCe library project for you. 

No source files were created as part of your project.


qyEncLib_winCe.vcproj
...
project, including "resource.h", "qyEncLib_winCe.rc" and a "qyEncLib_winCe.h" that 
