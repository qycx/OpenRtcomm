...
#ifndef  __lyraDecAPublic_h__
#define  __lyraDecAPublic_h__   //  {
...
MATH_API int lyraDecA_init(int bitrate, char* str_model_path,
                           PF_commonHandler4 pf_in, void* p0_in,
                           PF_commonHandler4 pf_out, void* p0_out,
                           void** ppLyraDecA);

    MATH_API int lyraDecA_exit(void** ppLyraDecA);

MATH_API int doLyraDecA(void* pLyraDecA,int * piStep);
