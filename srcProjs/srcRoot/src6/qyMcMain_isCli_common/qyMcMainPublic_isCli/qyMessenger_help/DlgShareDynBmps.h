...
public:
	...
	//
	int  toShareWebcam(  int  index_pShare_mem  );
	int  toShareWebcam_func(  int  index_pShare_mem,  void  **  ppCapStuff,   int  iMenuId_v,  BOOL  bUnresizable  );
	//
	...
	//
	int  chkAutoOpen(  );
	int  doAutoOpen_webcam(  int  index_pShare_mem,  WEBCAM_info  *  p  );
