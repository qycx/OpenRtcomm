 ...
 FUNCS_for_isCliHelp  *  FUNCS_for_isCliHelp_new(  QY_MC  *  pQyMc  )
{
	...
	//
	//pFuncs->pf_doCmd_startAvCall  =  confCli_doCmd_startAvCall;
	//
...
int  load_isCliD3d(LPCTSTR  fileName, LPCTSTR  fileName_dx12, FUNCS_for_isCliHelp* pFuncs)
{
	...
	//
	pFuncs->isCliD3d.pf_chkAndRecoverD3dImg_a = (PF_chkAndRecoverD3dImg)GetProcAddress(pFuncs->isCliD3d.hDll, "chkAndRecoverD3dImg_a");
