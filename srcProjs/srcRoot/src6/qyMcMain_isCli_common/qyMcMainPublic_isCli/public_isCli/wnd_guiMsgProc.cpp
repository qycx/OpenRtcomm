...
#include	"funcsForIsCliHelp.h"
 ...
 int  chkSharedObjSlave(  MIS_MSG_procVideo_qmc  *  pMsg,  BOOL  *  pbRedirected  )
 {
	 ...
	 //
	 int	iIndex_sharedObj_master  =  pCapBmp->iIndex_sharedObj;
	 QY_sharedObj_sync  *  pSharedObjInfo_master  =  getSharedObjSyncByIndex(  pProcInfo,  iIndex_sharedObj_master  );
	 ...
	 //
	 QY_SHARED_OBJ  *  pSharedObj_master  =  &pSharedObjInfo_master->sharedObj;
	 if  (  !pSharedObj_master->bUsed  )  goto  errLabel;

	 //
	 SHARED_OBJ_USR  *  pSharedObjUsr  =  getSharedObjUsr(  pSharedObj_master,  pSharedObj_master->iIndex_curUsr  );
	 if  (  !pSharedObjUsr  )  {
		 #ifdef  __DEBUG__
	 ...
	 //
	 QY_sharedObj_sync  *  pSharedObjInfo_slave  =  getSharedObjSyncByIndex(  pProcInfo,  iIndex_sharedObj_slave  );
	 ...
	 QY_SHARED_OBJ  *  pSharedObj_slave  =  &pSharedObjInfo_slave->sharedObj;
	 ...
	 //
	 CAP_procInfo_bmpCommon  *  pCapBmp_slave  =  (  CAP_procInfo_bmpCommon  *  )getCapBmpBySth(  pProcInfo,  pSharedObj_slave->iIndex_capBmp,  0  );	
