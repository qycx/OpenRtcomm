...
extern  "C"  DWORD  WINAPI  coreAudioRecThreadFunc(  LPVOID ignored  )
{
	...
	int  dst_nb_samples;
	int  dst_bufSize;
	int  nAvgBytesPerSec_resample  =  0;
	int  nBytes_toRecord_resample  =  0;
	...
	//
	 ...
	 int	iCapTimeInMs  =  40;
	 int  nBytes_toRecord  =  uiBytesRecorded_perBlockAlign  *  pwfx->nBlockAlign;
	 int  nAvgBytesPerSec  =  pwfx->nAvgBytesPerSec;
	...
	//  2017/01/28
	 ...
	 //
	 int iVal_sleep=iCapTimeInMs  * 0.7;

	 //
	 bool  bFailed_resample  =  false;
