...
BYTE  *  CPelco_D::BackLightCompensation(  UINT  deviceAddress,  Switch  action  )		//  背光补偿
{
...
BYTE  *  CPelco_D::EnableDevicePhaseDelay(  UINT  deviceAddress  )
{
...
{
	return  Package(  deviceAddress,  0x00,  0x37,  speed,  speed  );
}
...
BYTE  *  CPelco_D::CameraScan(  UINT  deviceAddress,  Scan  scan  )
{
	...
	if  (  scan  ==  Scan_Auto  )  m_byte  =  AutoManualScan  +  Sense;
