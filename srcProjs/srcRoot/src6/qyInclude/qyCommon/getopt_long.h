...
extern int getopt P((int argc, char *argv[], const char *shortopts));
extern int getopt_long P((int argc, char *argv[], char *shortopts,
			  struct option *longopts, int *longind));
extern int getopt_long_only P((int argc, char *argv[],
			       char *shortopts,
			       struct option *longopts, int *longind));

/* Internal only.  Users should not call this directly.  */
extern int _getopt_internal P((int argc, char *argv[],
