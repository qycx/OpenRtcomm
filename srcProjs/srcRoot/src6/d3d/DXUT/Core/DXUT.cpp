...
//////////////////////////
void GetDXUTState_SetDeviceCreateCalled(bool b)
{
    GetDXUTState().SetDeviceCreateCalled(b);
}

bool GetDXUTState_GetWindowCreated()
{
    return  GetDXUTState().GetWindowCreated();
}

bool GetDXUTState_GetWindowCreateCalled()
{
    return GetDXUTState().GetWindowCreateCalled();
}

void GetDXUTState_SetWindowCreateCalled(bool b)
{
    GetDXUTState().SetWindowCreateCalled(b);
}

bool GetDXUTState_GetRenderingOccluded()
{
    return GetDXUTState().GetRenderingOccluded();
}

void GetDXUTState_SetRenderingOccluded(bool b)
{
    GetDXUTState().SetRenderingOccluded(b);
}

int GetDXUTState_GetCurrentFrameNumber()
{
    return GetDXUTState().GetCurrentFrameNumber();
}

void GetDXUTState_SetCurrentFrameNumber(int nFrame)
{
    GetDXUTState().SetCurrentFrameNumber(nFrame);
}

int GetDXUTState_GetOverrideQuitAfterFrame()
{
    return GetDXUTState().GetOverrideQuitAfterFrame();
}

bool GetDXUTState_GetInsideDeviceCallback()
{
    return GetDXUTState().GetInsideDeviceCallback();
}

bool GetDXUTState_GetDXUTInited()
{
    return GetDXUTState().GetDXUTInited();
}

bool GetDXUTState_GetDXUTInitCalled()
{
    return GetDXUTState().GetDXUTInitCalled();
}

void GetDXUTState_SetHInstance(HINSTANCE hInstance)
{
    GetDXUTState().SetHInstance(hInstance);
}


int GetDXUTState_GetOverrideStartX()
{
    return GetDXUTState().GetOverrideStartX();
}

int GetDXUTState_GetOverrideStartY()
{
    return GetDXUTState().GetOverrideStartY();
}

void GetDXUTState_SetWindowCreatedWithDefaultPositions(bool b)
{
    GetDXUTState().SetWindowCreatedWithDefaultPositions(b);
}

int GetDXUTState_GetOverrideWidth()
{
    return GetDXUTState().GetOverrideWidth();
}

int GetDXUTState_GetOverrideHeight()
{
    return GetDXUTState().GetOverrideHeight();
}

WCHAR* GetDXUTState_GetWindowTitle()
{
    return GetDXUTState().GetWindowTitle();
}


void GetDXUTState_SetWindowCreated(bool b)
{
    GetDXUTState().SetWindowCreated(b);
}


void GetDXUTState_SetHWNDFocus(HWND hWnd)
{
    GetDXUTState().SetHWNDFocus(hWnd);
}


void GetDXUTState_SetHWNDDeviceFullScreen(HWND hWnd)
{
    GetDXUTState().SetHWNDDeviceFullScreen(hWnd);
}

void GetDXUTState_SetHWNDDeviceWindowed(HWND hWnd)
{
    GetDXUTState().SetHWNDDeviceWindowed(hWnd);
}


bool* GetDXUTState_GetKeys()
{
    return GetDXUTState().GetKeys();
}

LPDXUTCALLBACKKEYBOARD GetDXUTState_GetKeyboardFunc()
{
    return GetDXUTState().GetKeyboardFunc();
}

void* GetDXUTState_GetKeyboardFuncUserContext()
{
    return GetDXUTState().GetKeyboardFuncUserContext();
}

bool GetDXUTState_GetNotifyOnMouseMove()
{
    return GetDXUTState().GetNotifyOnMouseMove();
}


bool* GetDXUTState_GetMouseButtons()
{
    return GetDXUTState().GetMouseButtons();
}

LPDXUTCALLBACKMOUSE GetDXUTState_GetMouseFunc()
{
    return GetDXUTState().GetMouseFunc();
}


void* GetDXUTState_GetMouseFuncUserContext()
{
    return GetDXUTState().GetMouseFuncUserContext();
}

LPDXUTCALLBACKMSGPROC GetDXUTState_GetWindowMsgFunc()
{
    return GetDXUTState().GetWindowMsgFunc();
}

void* GetDXUTState_GetWindowMsgFuncUserContext()
{
    return GetDXUTState().GetWindowMsgFuncUserContext();
}


bool GetDXUTState_GetDeviceObjectsCreated()
{
    return GetDXUTState().GetDeviceObjectsCreated();
}

bool GetDXUTState_GetDeviceObjectsReset()
{
    return GetDXUTState().GetDeviceObjectsReset();
}

LPDXUTCALLBACKD3D11FRAMERENDER GetDXUTState_GetD3D11FrameRenderFunc()
{
    return GetDXUTState().GetD3D11FrameRenderFunc();
}


void* GetDXUTState_GetD3D11FrameRenderFuncUserContext()
{
    return GetDXUTState().GetD3D11FrameRenderFuncUserContext();
}



DXUTDeviceSettings* GetDXUTState_GetCurrentDeviceSettings()
{
    return GetDXUTState().GetCurrentDeviceSettings();
}

void GetDXUTState_SetWindowBackBufferWidthAtModeChange(int w)
{
    GetDXUTState().SetWindowBackBufferWidthAtModeChange(w);
}

void GetDXUTState_SetWindowBackBufferHeightAtModeChange(int h)
{
    GetDXUTState().SetWindowBackBufferHeightAtModeChange(h);
}

void GetDXUTState_SetFullScreenBackBufferWidthAtModeChange(int w)
{
    GetDXUTState().SetFullScreenBackBufferWidthAtModeChange(w);
}

void GetDXUTState_SetFullScreenBackBufferHeightAtModeChange(int h)
{
    GetDXUTState().SetFullScreenBackBufferHeightAtModeChange(h);
}

bool GetDXUTState_GetReleasingSwapChain()
{
    return GetDXUTState().GetReleasingSwapChain();
}

void GetDXUTState_SetMinimized(bool b)
{
    GetDXUTState().SetMinimized(b);
}

void GetDXUTState_SetMaximized(bool b)
{
    GetDXUTState().SetMaximized(b);
}

bool GetDXUTState_GetMinimized()
{
    return GetDXUTState().GetMinimized();
}

bool GetDXUTState_GetMaximized()
{
    return GetDXUTState().GetMaximized();
}

//
void GetDXUTState_SetInSizeMove(bool b)
{
    return GetDXUTState().SetInSizeMove(b);
}

bool GetDXUTState_GetShowCursorWhenFullScreen()
{
    return GetDXUTState().GetShowCursorWhenFullScreen();
}

void GetDXUTState_SetActive(bool b)
{
    GetDXUTState().SetActive(b);
}

bool GetDXUTState_GetMinimizedWhileFullscreen()
{
    return GetDXUTState().GetMinimizedWhileFullscreen();
}

void GetDXUTState_SetMinimizedWhileFullscreen(bool b)
{
    return GetDXUTState().SetMinimizedWhileFullscreen(b);
}

bool GetDXUTState_GetAllowShortcutKeysWhenWindowed()
{
    return GetDXUTState().GetAllowShortcutKeysWhenWindowed();
}

bool GetDXUTState_GetAllowShortcutKeysWhenFullscreen()
{
    return GetDXUTState().GetAllowShortcutKeysWhenFullscreen();
}

void GetDXUTState_SetLastStatsUpdateTime(double t)
{
    GetDXUTState().SetLastStatsUpdateTime(t);
}

bool GetDXUTState_GetHandleEscape()
{
    return GetDXUTState().GetHandleEscape();
}

bool GetDXUTState_GetHandlePause()
{
    return GetDXUTState().GetHandlePause();
}

bool GetDXUTState_GetInSizeMove()
{
    return GetDXUTState().GetInSizeMove();
}

bool GetDXUTState_GetCallDefWindowProc()
{
    return GetDXUTState().GetCallDefWindowProc();
}

HMENU GetDXUTState_GetMenu()
{
    return GetDXUTState().GetMenu();
}

bool GetDXUTState_GetExitAfterScreenShot()
{
    return GetDXUTState().GetExitAfterScreenShot();

}

bool GetDXUTState_GetSaveScreenShot()
{
    return GetDXUTState().GetSaveScreenShot();
}

WCHAR* GetDXUTState_GetScreenShotName()
{
    return GetDXUTState().GetScreenShotName();
}

void * GetDXUTState_GetFrameMoveFuncUserContext()
{
    return GetDXUTState().GetFrameMoveFuncUserContext();
}

bool GetDXUTState_GetRenderingPaused()
{
    return GetDXUTState().GetRenderingPaused();
}

void GetDXUTState_SetTime(double fTime)
{
    GetDXUTState().SetTime(fTime);
}

void GetDXUTState_SetAbsoluteTime(double fAbsTime)
{
    GetDXUTState().SetAbsoluteTime(fAbsTime);
}

void      GetDXUTState_SetElapsedTime(double fElapsedTime)
{
...
bool GetDXUTState_GetConstantFrameTime()
{
    return GetDXUTState().GetConstantFrameTime();
}

float GetDXUTState_GetTimePerFrame()
{
    return GetDXUTState().GetTimePerFrame();
}

void GetDXUTState_SetDeviceObjectsReset(bool b)
{
    GetDXUTState().SetDeviceObjectsReset(b);
}

LPDXUTCALLBACKFRAMEMOVE GetDXUTState_GetFrameMoveFunc()
{
    return GetDXUTState().GetFrameMoveFunc();
}

void* GetDXUTState_GetD3D11SwapChainResizedFuncUserContext()
{
    return GetDXUTState().GetD3D11SwapChainResizedFuncUserContext();
}

void GetDXUTState_SetInsideDeviceCallback(bool b)
{
    GetDXUTState().SetInsideDeviceCallback(b);
}


void GetDXUTState_SetDeviceObjectsCreated(bool b)
{
    GetDXUTState().SetDeviceObjectsCreated(b);
}

void *GetDXUTState_GetD3D11DeviceCreatedFuncUserContext()
{
    return GetDXUTState().GetD3D11DeviceCreatedFuncUserContext();
}


LPDXUTCALLBACKD3D11DEVICECREATED GetDXUTState_GetD3D11DeviceCreatedFunc()
{
    return GetDXUTState().GetD3D11DeviceCreatedFunc();
}

void GetDXUTState_SetD3D11DeviceContext1(ID3D11DeviceContext1* pd3dImmediateContext1)
{
    GetDXUTState().SetD3D11DeviceContext1(pd3dImmediateContext1);
}

void GetDXUTState_SetD3D11Device1(ID3D11Device1* pd3d11Device1)
{
    GetDXUTState().SetD3D11Device1(pd3d11Device1);
}


void GetDXUTState_SetD3D11Device(ID3D11Device * pd3d11Device)
{
    GetDXUTState().SetD3D11Device(pd3d11Device);
}

void GetDXUTState_SetD3D11DeviceContext(ID3D11DeviceContext * pd3dImmediateContext)
{
    GetDXUTState().SetD3D11DeviceContext(pd3dImmediateContext);
}

void GetDXUTState_SetD3D11FeatureLevel(D3D_FEATURE_LEVEL FeatureLevel)
{
    GetDXUTState().SetD3D11FeatureLevel(FeatureLevel);
}

void GetDXUTState_SetDXGISwapChain(IDXGISwapChain * pSwapChain)
{
    GetDXUTState().SetDXGISwapChain(pSwapChain);
}

void GetDXUTState_SetDXGIOutputArray(IDXGIOutput** ppOutputArray)
{
    GetDXUTState().SetDXGIOutputArray(ppOutputArray);
}

void GetDXUTState_SetDXGIOutputArraySize(UINT OutputCount)
{
    GetDXUTState().SetDXGIOutputArraySize(OutputCount);
}

void GetDXUTState_SetD3D11RasterizerState(ID3D11RasterizerState * pRS)
{
    GetDXUTState().SetD3D11RasterizerState(pRS);
}

void GetDXUTState_SetDXGIAdapter(IDXGIAdapter1 * pAdapter)
{
    GetDXUTState().SetDXGIAdapter(pAdapter);
}

void GetDXUTState_SetDXGIFactory(IDXGIFactory1 * pDXGIFactory)
{
    GetDXUTState().SetDXGIFactory(pDXGIFactory);
}

IDXGIFactory1* GetDXUTState_GetDXGIFactory()
{
    return GetDXUTState().GetDXGIFactory();
}


void GetDXUTState_SetIgnoreSizeChange(bool b)
{
    GetDXUTState().SetIgnoreSizeChange(b);
}

void GetDXUTState_SetDeviceCreated(bool b)
{
    GetDXUTState().SetDeviceCreated(b);
}

bool GetDXUTState_GetTopmostWhileWindowed()
{
    return GetDXUTState().GetTopmostWhileWindowed();
}

WINDOWPLACEMENT * GetDXUTState_GetWindowedPlacement()
{
    return GetDXUTState().GetWindowedPlacement();
}

void GetDXUTState_SetWindowBackBufferWidthAtModeChange(UINT w)
{
    GetDXUTState().SetWindowBackBufferWidthAtModeChange(w);
}

void GetDXUTState_SetWindowBackBufferHeightAtModeChange(UINT h)
{
    GetDXUTState().SetWindowBackBufferHeightAtModeChange(h);
}

void* GetDXUTState_GetModifyDeviceSettingsFuncUserContext()
{
    return GetDXUTState().GetModifyDeviceSettingsFuncUserContext();
}

void GetDXUTState_SetCurrentDeviceSettings(DXUTDeviceSettings * pNewDeviceSettingsOnHeap)
{
    GetDXUTState().SetCurrentDeviceSettings(pNewDeviceSettingsOnHeap);
}

LPDXUTCALLBACKMODIFYDEVICESETTINGS GetDXUTState_GetModifyDeviceSettingsFunc()
{
    return GetDXUTState().GetModifyDeviceSettingsFunc();

}


DWORD GetDXUTState_GetWindowedStyleAtModeChange()
{
    return GetDXUTState().GetWindowedStyleAtModeChange();
}

int GetDXUTState_GetExitCode()
{
    return  GetDXUTState().GetExitCode();
}

void GetDXUTState_SetExitCode(int t)
{
    GetDXUTState().SetExitCode(t);
}

void GetDXUTState_SetAdapterMonitor(HMONITOR hAdapterMonitor)
{
    GetDXUTState().SetAdapterMonitor(hAdapterMonitor);
}

LPDXUTCALLBACKD3D11SWAPCHAINRESIZED GetDXUTState_GetD3D11SwapChainResizedFunc()
{
    return GetDXUTState().GetD3D11SwapChainResizedFunc();
}
