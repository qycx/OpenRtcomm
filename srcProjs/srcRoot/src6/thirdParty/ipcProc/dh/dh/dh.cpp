...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   do {
       ...
       if (initShowInfo_func(0, _T("syncQ_showInfo_dh"), errHintWndCls, false, true, (char*)"127.0.0.1", bCli, &gBuf_dh.m_var.pShowInfoStruct)) {
           //goto  errLabel;
           break;
       }
       ...
       //
       set_who_showInfo(_T("dh"));

       //
       TCHAR* cmdLine = GetCommandLine();
       //
       showInfo_open0(0, _T("dh.haha"), cmdLine);
       //
   ...
   //
       {
           ...
           //		  
           M_get_pipeName(CONST_ipcProcPipePrefix, _T(""), CONST_ipcProcPipe_tn_dhListIp, pipeName);
           ...
           //
           initQisPipe(&qCfg, pipeName, true, _T("dh.listIp"), &param, gBuf_dh.m_var.dhListIp.pQisPipe);
       ...
       //
       {
           ...
           //
           initQisPipe(&qCfg, pipeName, true, _T("dh.ptz"), &param, gBuf_dh.m_var.dhDeviceControl.pQisPipe);
...
VOID (__stdcall myTimerProc)(HWND  hWnd, UINT, UINT_PTR, DWORD)
{
    ...
    if (!gBuf_dh.m_var.dhListIp.tool.hProcess_ipcProc) {
        ...
        //
#if 10
        createTool_ipcProc(gBuf_dh.m_var.cfg.installDir, CONST_iNvrType_dhListIp, gBuf_dh.m_var.appParams.nvrIp, gBuf_dh.m_var.appParams.nvrUsr,gBuf_dh.m_var.appParams.nvrPwd,  gBuf_dh.m_var.dhListIp.tool.tn,  _T(""), _T(""), &gBuf_dh.m_var.dhListIp.tool);
#endif
    }
    if (!gBuf_dh.m_var.dhDeviceControl.tool.hProcess_ipcProc) {
        ...
        //
#if 10
        createTool_ipcProc(gBuf_dh.m_var.cfg.installDir, CONST_iNvrType_dhDeviceControl, gBuf_dh.m_var.appParams.nvrIp, gBuf_dh.m_var.appParams.nvrUsr, gBuf_dh.m_var.appParams.nvrPwd, gBuf_dh.m_var.dhDeviceControl.tool.tn,_T(""), _T(""), &gBuf_dh.m_var.dhDeviceControl.tool);
#endif
    }
