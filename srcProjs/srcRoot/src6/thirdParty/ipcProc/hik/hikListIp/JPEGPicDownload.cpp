...
BOOL CJPEGPicDownload::OnInitDialog() 
{
	...
	g_StringLanType(szLan, "抓拍报警", "Detect face alarm");
	m_PicTypeCtrl.AddString(szLan);
...
//#endif //NET_DVR_GET_TRAVERSE_PLANE_DETECTION
    ...
    g_StringLanType(szLan, "抓拍", "Face snap");
    m_PicTypeCtrl.AddString(szLan);
    ...
    g_StringLanType(szLan, "抓拍建模", "Face Snap Modeling");
    m_PicTypeCtrl.AddString(szLan);
    ...
    g_StringLanType(szLan, "岗位状态检测", "personDensity");
    m_PicTypeCtrl.AddString(szLan);
