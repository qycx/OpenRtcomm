...
DWORD CServerAuth::StartAuth(LPCTSTR pszReqInfo, LPCTSTR lpszClientIP)
{
	...
	showInfo_open0(0, 0, _T("StartAuth 00000000"));
	...
	if (pszReqInfo == NULL)
	{
		...
		showInfo_open0(0, 0, _T("StartAuth 111111111"));
		return dwRet;
	}
	...
	if (m_bIsPlain == false)
	{
		...
		if (dwRet == AUTH_CODE_SUCCESS && nLength > 1)
		{
			...
			if (strReponseHttpBody != NULL)
			{
				...
				if (nLength <= 1)
				{
					showInfo_open0(0, 0, _T("StartAuth 222222222222"));
					return dwRet;
				}
			}
		...
		{
			showInfo_open0(0, 0, _T("StartAuth 222222222222aaa"));
			return dwRet;
		}
	}
	else
	{
		//明文
		showInfo_open0(0, 0, _T("StartAuth 222222222222 - mw"));
		...
		if (dwRet == AUTH_CODE_SUCCESS && nLength > 1)
		{
			...
			if (strReponseHttpBody != NULL)
			{
				...
				if (nLength <= 1)
				{
					showInfo_open0(0, 0, _T("StartAuth 333333333333"));
					return dwRet;
				}
			}
		...
		{
			showInfo_open0(0, 0, _T("StartAuth 444444444444"));
			return dwRet;
		}
	}
	...
	{
		dwRet = AUTH_CODE_FAIL;
		showInfo_open0(0, 0, _T("StartAuth 555555555555555111:AUTH_CODE_FAIL"));
		return dwRet;
	}
	...
	for (iter = m_structReponseInfo.Body.AuthResults.begin(); iter != m_structReponseInfo.Body.AuthResults.end(); ++iter)
	{
		...
		{
			dwRet = AUTH_CODE_FAIL;
			showInfo_open0(0, 0, _T("StartAuth 555555555555555:AUTH_CODE_FAIL"));
			return dwRet;
		}
	}
	...
	if (NULL != m_structReponseInfo.Body.AccessControl && _tcsicmp(m_structReponseInfo.Body.AccessControl, _T("Deny")) == 0)
	{
		...
		showInfo_open0(0, 0, _T("StartAuth 555555555555555:AUTH_CODE_DENY"));
		return dwRet;
	}

	TCHAR buf[1024] = { 0 };
	_stprintf_s(buf, _T("StartAuth 555555555555555:dwRet=%d"), dwRet);
...
DWORD CServerAuth::SendRequest_Plain(LPCTSTR pszReqInfo, LPCTSTR pszGateWayIP, unsigned short usGatePort, PTCHAR strReponseHttpBody, DWORD& nLength)
{
	...
	showInfo_open0(0, 0, _T("SendRequest_Plain 11111111"));
	...
	showInfo_open0(0, 0, _T("SendRequest_Plain 2222222"));
	...
	showInfo_open0(0, 0, _T("SendRequest_Plain 33333333333333"));
	...
	showInfo_open0(0, 0, _T("SendRequest_Plain 44444444444"));
	...
	TCHAR buf[1024] = { 0 };
	_stprintf_s(buf, _T("SendRequest_Plain 555555555555555:dwRet=%d,nLength=%d"), dwRet, nLength);
	showInfo_open0(0, 0, buf);
	showInfo_open0(0, 0, _T("SendRequest_Plain 555555555555555"));
