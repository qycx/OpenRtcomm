...
#include	"qnmCustomStr_is.h"
 ...
 QY_DMITEM  CONST_strTable_isMgr[]  =
{
	{	CONST_resId_null,					_T(  ""  ),				},
	//
	...
	//  "popup_messenger  -  100
		...
		//
		{	ID_notSuperAdmin,							CONST_ID_notSuperAdmin,		},
		{	ID_setAsSuperAdmin,							CONST_ID_setAsSuperAdmin,		},
		//
	...
	{	CONST_resId_menu_guanLi,					CONST_ID_menu_guanLi,		},
		...
		{	CONST_resId_menu_fenZuGuanLi,				CONST_ID_menu_fenZuGuanLi,			},
			...
			{	ID_qyImGrpAuthMemList,						CONST_ID_qyImGrpAuthMemList,	},
			...
			{	IDC_STATIC_subtype,							CONST_str_subtype,				},
...
/*		{	CONST_resId_menu_renWuChaKan,				CONST_ID_menu_renWuChaKan,	},
			{	ID_qyUnprocedNewTaskList,					CONST_ID_qyUnprocedNewTaskList,		},
			...
			{	ID_qyNewTaskList,							CONST_ID_qyNewTaskList,			},
			{	ID_qyTaskHisList,							CONST_ID_qyTaskHisList,			},
			//
...
*/
	...
	{	CONST_resId_menu_chaKan,			CONST_ID_menu_chaKan,					},
		...
		//
		{	ID_whatToShow,						_T(  "Status to show"  ),			},
		{	ID_showPktInOn,						_T(  "Show pkt in"  ),				},
		{	ID_showPktInOff,					_T(  "Not show pkt in"  ),			},
		{	ID_showPktOutOn,					_T(  "Show pkt out"  ),				},
		{	ID_showPktOutOff,					_T(  "Not show pkt out"  ),			},
		{	ID_showProcBtOn,					_T(  "Show proc bt"  ),				},
		{	ID_showProcBtOff,					_T(  "Not show proc bt"  ),			},
		{	ID_showPSelfOn,						_T(  "Show proc self"  ),			},
		{	ID_showPSelfOff,					_T(  "Not show proc self"  ),		},
		{	ID_showNoCorrespondingOn,			_T(  "Show no corresponding"  ),	},
		{	ID_showNoCorrespondingOff,			_T(  "Not show no corresponding"  ),},
		{	ID_showPostMsg2OutputQ_msgrOn,		_T(  "Show postMsg2OutputQ_msgr"  ),	},
		{	ID_showPostMsg2OutputQ_msgrOff,		_T(  "Not show postMsg2OutputQ_msgr"  ),	},
		{	ID_showBigElapseOn,					_T(  "Show print big elapse"  ),	},
		{	ID_showBigElapseOff,				_T(  "Not show print big elapse"  ),	},
		{	ID_showSwitchRouteQOn,				_T(  "Show switchRouteQ"  ),  },
		{	ID_showSwitchRouteQOff,				_T(  "Not show switchRouteQ"  ),  },
		...
		//  2014/02/09
		{	ID_test_createUsr,					CONST_ID_test_createUsr,		},
	...
	{	CONST_resId_STATIC_clientWelcomeMsg,			CONST_ID_STATIC_clientWelcomeMsg,		},
	...
	{	IDD_cfgSystemParams_is,							CONST_str_cfgSystemParams,	},
		...
		{	CONST_resId_cliThreads,								CONST_str_cliThreads,			},		//  2015/09/02
		{	CONST_resId_mgrThreads_cs,							CONST_str_mgrThreads_cs,		},		//  2015/09/02
		{	CONST_resId_mgrThreads_route,						CONST_str_mgrThreads_route,		},		//  2015/09/02
		{	CONST_resId_mgrThreads_sw,							CONST_str_mgrThreads_sw,		},		//  2015/09/03
	...
	{	IDD_exportClients,								CONST_str_pleaseSelect,				},
		...
		{	CONST_resId_ppExportClientHint,					CONST_ppExportClientHint,		},		//  2015/11/10
	...
	{	IDD_policy_isMgr,							CONST_IDD_policy_isMgr,		},
		{	IDC_CHECK_ucbLogImMsg,						CONST_IDC_CHECK_ucbLogImMsg,	},
		//
		{	IDC_STATIC_hintForMcu,				CONST_IDC_STATIC_hintForMcu,  },
		{	IDC_STATIC_startMcuId,				CONST_IDC_STATIC_startMcuId,},
		{	IDC_STATIC_cntofMcus,				CONST_IDC_STATIC_cntofMcus,},
		{	IDC_STATIC_hintForMcuUsr,			CONST_IDC_STATIC_hintForMcuUsr,},
		{	IDC_STATIC_mcuUsrName,				CONST_IDC_STATIC_mcuUsrName,},
		{	IDC_STATIC_mcuPasswd,				CONST_IDC_STATIC_mcuPasswd,	},
		{	IDC_STATIC_mcuDomainName,			CONST_IDC_STATIC_mcuDomainName,},
		//
		{	IDC_STATIC_offlineResServDir,		CONST_IDC_STATIC_offlineResServDir,	},
		{	IDC_CHECK_bUseManuallySetResServId,	CONST_IDC_CHECK_bUseManuallySetResServId,},

		//
		{	IDC_STATIC_hintForTmpMessengerId,			CONST_IDC_STATIC_hintForTmpMessengerId,		},
		{	IDC_STATIC_startTmpMessengerId,				CONST_IDC_STATIC_startTmpMessengerId,		},
		{	IDC_STATIC_endTmpMessengerId,				CONST_IDC_STATIC_endTmpMessengerId,			},
		//{	IDC_STATIC_offlineResServID,				CONST_IDC_STATIC_offlineResServDir,			},
...
#endif
		{	IDC_STATIC_usMaxMsgs_allowedToSwitchToTalkChannel_robot,		CONST_IDC_STATIC_usMaxMsgs_allowedToSwitchToTalkChannel_robot,		},
		{	IDC_STATIC_usMaxMsgs_allowedToSwitchToTalkChannel_media,		CONST_IDC_STATIC_usMaxMsgs_allowedToSwitchToTalkChannel_media,		},
		//
		{	IDC_CHECK_notUseP2pCall,	CONST_IDC_CHECK_notUseP2pCall,	},
#if  0
		//
	...
	*/
	...
	{	IDD_qnmCfgAdvancedOptions,				CONST_IDD_qnmCfgAdvancedOptions,		},
		...
		{	IDC_STATIC_dbServName,				CONST_IDC_STATIC_dbServName,					},		
		{	IDC_RADIO_useWinAuth,				CONST_IDC_RADIO_useWinAuth,					},				//  2014/02/07
		{	IDC_RADIO_useSqlAuth,				CONST_IDC_RADIO_useSqlAuth,					},				//  2014/02/07
...
//
	...
	{	CONST_resId_mcuList,					CONST_str_mcuList,			},	//2021/05/26
	//
	...
	{	CONST_resId_importOkHint,					CONST_str_importOkHint,						},
	...
	//
	{	ID_notMgr,										CONST_ID_notMgr,				},
	{	ID_setAsMgr,									CONST_ID_setAsMgr,	},
...
// 	{	IDD_qyBar,								CONST_IDD_qyBar,		},
	...
	{	ID_viewMcuStatus,							CONST_ID_viewMcuStatus, },
