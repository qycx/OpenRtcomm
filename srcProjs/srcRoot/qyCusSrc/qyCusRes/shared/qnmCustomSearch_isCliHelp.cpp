...
//  主机列表查询条件定制
 static QY_IDCITEM  CONST_zjgaPcListSearchTable0[]  =
{
#if  0
	...
	{	IDC_STATIC5,		CONST_qyIdcType_static, 	CONST_str_usr,							0,	0,		NULL,					64,   164, 70,  47,  10,	0,													NULL,							_T(  "static使用人"  ),							},
...
static  QY_IDCITEM  CONST_zjgaPcListSearchCb0Table0[]  =
{	
 ...
 static  QY_IDCITEM  CONST_zjgaPcListSearchCb0Table1[]  =
{	
 ...
 //  事件列表查询条件定制
 static  QY_IDCITEM  CONST_zjgaEventListSearchTable0[]  =
{
#if  0
 ...
 static  QY_IDCITEM  CONST_zjgaEventListSearchCb0Table0[]  =
{	
	//  {	IDC_STATIC1,			CONST_qyIdcType_static, 		CONST_str_otherDepart,					0,	0,		NULL,						64,   151, 61,  50,  14,	CONST_qyIdcFlgPermitZw  |  CONST_qyIdcFlgHide,			NULL,					_T(  "static其它单位"  ),	},
 ...
 static QY_IDCITEM  CONST_zjgaEventListSearchCb0Table1[]  =
{	
	//  {	IDC_STATIC1,			CONST_qyIdcType_static, 		CONST_str_otherDepart,					0,	0,		NULL,						64,   151, 61,  50,  14,	CONST_qyIdcFlgPermitZw,									NULL,					_T(  "static其它单位"  ),	},
  ...
  //  网络事件列表查询条件定制
 static QY_IDCITEM  CONST_zjgaNetDevEventListSearchTable0[]  =
{
 ...
 static  QY_IDCITEM  CONST_zjgaOpEventListSearchTable0[]  =
{
	{	IDC_STATIC_hint,		CONST_qyIdcType_static, 			CONST_str_input,		0,	0,		NULL,								64,   29,  17,  134,  11,	0,																					NULL,					_T(  "提示0"  ),			},
  ...
  //  安检结果查询条件定制
 static  QY_IDCITEM  CONST_zjgaSecChkEventListSearchTable0_netMc2[]  =
{
#if  0
	{	IDC_STATIC_hint,		CONST_qyIdcType_static, 			CONST_str_input,						0,	0,		NULL,								64,   29,  17,  64,  11,	0,																												NULL,							_T(  "提示0"  ),												},
	{	IDC_STATIC_eventType,	CONST_qyIdcType_static,				CONST_str_eventType,					0,	0,		NULL,								64,   24,  38,  40,  14,	0,																												NULL,							_T(  "static事件类型"  ),										},
  ...
  //  安检结果查询条件定制
 static  QY_IDCITEM  CONST_zjgaSecChkEventListSearchTable0_secChk[]  =
{
#if  0
	{	IDC_STATIC_hint,		CONST_qyIdcType_static, 			CONST_str_input,						0,	0,		NULL,								64,   29,  17,  64,  11,	0,																												NULL,							_T(  "提示0"  ),												},
	{	IDC_STATIC_eventType,	CONST_qyIdcType_static,				CONST_str_eventType,					0,	0,		NULL,								64,   24,  38,  40,  14,	0,																												NULL,							_T(  "static事件类型"  ),										},
...
////统计
////////////////////  2008/12/19
 static  QY_IDCITEM	 CONST_statIpScanTable0[]  =
{
#if  0
 ...
 static  QY_IDCITEM  CONST_zjgaStatPcInfoTable0[]  =
{
#if  0
 ...
 static  QY_IDCITEM  CONST_zjgaStatPcInfoCb0Table0[]  =
{
	{	IDC_COMBO1,			CONST_qyIdcType_comboDesc,	0/*gYhGrpTable[0].des*/,				0,	0,		CONST_resId_gYhGrpTable,	64,	  65,  53,  69,  12,	0,															NULL,					_T(  "统计分组单位"  ),		},
	{	IDC_COMBO2,			CONST_qyIdcType_comboDesc,	NULL,									0,	0,		NULL,					64,	  65,  53,  69,  12,	CONST_qyIdcFlgHide,											NULL,					_T(  "统计分组单位"  ),		},
	{	-1,					NULL,																			},
 ...
 static  QY_IDCITEM  CONST_zjgaStatPcInfoCb0Table1[]  =
{
 ...
 static  QY_IDCITEM  CONST_zjgaStatUsrInfoTable0[]  =
{
#if  0
	{	IDC_STATIC0,		CONST_qyIdcType_static,		CONST_str_userType,						0,  0,		NULL,					64,	  20,  31,  42,  14,	CONST_qyIdcFlgHide,											NULL,					_T(  "static用户类型"  ),	},
	{	IDC_COMBO0,			CONST_qyIdcType_combo,		0/*CONST_zjgaYhlxTable[0].des*/,		0,	0,		CONST_resId_zjgaYhlxTable,	64,	  65,  31,  69,  12,	CONST_qyIdcFlgHide,											_T(  "qyPcRegInfoTab.col0"  ),	_T(  "用户类型"  ),			},
 ...
 static  QY_IDCITEM  CONST_zjgaStatUsrInfoCb0Table0[]  =
{
	{	IDC_COMBO1,			CONST_qyIdcType_comboDesc,	0/*gYhGrpTable[0].des*/,	0,	0,		CONST_resId_gYhGrpTable,	64,	  65,  53,  69,  12,	0,															NULL,					_T(  "统计分组单位"  ),		},
	{	IDC_COMBO2,			CONST_qyIdcType_comboDesc,	NULL,							0,	0,		NULL,					64,	  65,  53,  69,  12,	CONST_qyIdcFlgHide,											NULL,					_T(  "统计分组单位"  ),		},
	{	-1,					NULL,										},
 ...
 static  QY_IDCITEM  CONST_zjgaStatUsrInfoCb0Table1[]  =
{
	{	IDC_COMBO1,			CONST_qyIdcType_comboDesc,	0/*gYhGrpTable[0].des*/,	0,	0,		CONST_resId_gYhGrpTable,	64,	  65,  53,  69,  12,	CONST_qyIdcFlgHide,											NULL,					_T(  "统计分组单位"  ),		},
	{	IDC_COMBO2,			CONST_qyIdcType_comboDesc,	NULL,							0,	0,		NULL,					64,	  65,  53,  69,  12,	0,															NULL,					_T(  "统计分组单位"  ),		},
	{	-1,					NULL,										},
 ...
 static  QY_IDCITEM  CONST_zjgaStatGeneralTable0[]  =
{
#if  0
 ...
 static  QY_IDCITEM  CONST_zjgaStatGeneralCb0Table0[]  =
{	
	{	IDC_COMBO1,			CONST_qyIdcType_comboDesc,	0/*gEventYhGrpTable[0].des*/,			0,	0,		CONST_resId_gEventYhGrpTable,		64,	  65,  40,  52,  12,	0,															NULL,					_T(  "统计分组单位"  ),		},
	{	IDC_COMBO2,			CONST_qyIdcType_comboDesc,	NULL,									0,	0,		NULL,								64,	  65,  40,  52,  12,	CONST_qyIdcFlgHide,											NULL,					_T(  "统计分组单位"  ),		},
	{	-1,					NULL,		},
 ...
 static  QY_IDCITEM  CONST_zjgaStatGeneralCb0Table1[]  =
{	
 ...
 static  QY_IDCITEM  CONST_zjgaStatOthersTable0[]  =
{
#if  0
 ...
 static   QY_IDCITEM  CONST_statMessengerInfoTable0[]  =
{
#if  0
	{	IDC_STATIC0,		CONST_qyIdcType_static,		CONST_str_userType,					0,  0,		NULL,							64,	  20,  31,  42,  14,	CONST_qyIdcFlgHide,											NULL,								_T(  "static用户类型"  ),	},
...
static  QY_IDCITEM  CONST_statMessengerInfoCb0Table0[]  =
{
	{	IDC_COMBO1,			CONST_qyIdcType_comboDesc,	0/*gYhGrpTable[0].des*/,			0,	0,		CONST_resId_gYhGrpTable,		64,	  90,  53,  69,  12,	0,															NULL,					_T(  "统计分组单位"  ),		},
	{	IDC_COMBO2,			CONST_qyIdcType_comboDesc,	NULL,								0,	0,		NULL,							64,	  90,  53,  69,  12,	CONST_qyIdcFlgHide,											NULL,					_T(  "统计分组单位"  ),		},
	{	-1,					NULL,										},
 ...
 static  QY_IDCITEM  CONST_statMessengerInfoCb0Table1[]  =
{
	{	IDC_COMBO1,			CONST_qyIdcType_comboDesc,	0/*gYhGrpTable[0].des*/,				0,	0,		CONST_resId_gYhGrpTable,		64,	  65,  53,  69,  12,	CONST_qyIdcFlgHide,											NULL,					_T(  "统计分组单位"  ),		},
	{	IDC_COMBO2,			CONST_qyIdcType_comboDesc,	NULL,									0,	0,		NULL,							64,	  65,  53,  69,  12,	0,															NULL,					_T(  "统计分组单位"  ),		},
	{	-1,					NULL,										},
 ...
 static  QY_IDCITEM	 CONST_pcPropertiesTable0[]  =
{
...
static  QY_IDCITEM  *	gpPcListSearchTable0					=	CONST_zjgaPcListSearchTable0;
#ifdef  __ZJST__
		static  QY_IDCITEM	*	gpPcListSearchCb0Tables[]		=	{  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,   CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table1,  NULL,	};
#endif __ZJST__
static  QY_IDCITEM	*	gpPcListSearchCb1Tables[]				=	{	NULL,	};
static  QY_IDCITEM	*	gpEventListSearchTable0					=	CONST_zjgaEventListSearchTable0;
#ifdef  __ZJST__
		static  QY_IDCITEM	*	gpEventListSearchCb0Tables[]	=	{  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,   CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table1,  NULL,	};
#endif __ZJST__
#ifdef  __HZSJ__
		static  QY_IDCITEM	*	gpPcListSearchCb0Tables[]		=	{  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,   CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table0,  CONST_zjgaPcListSearchCb0Table1,  NULL,	 };
		static  QY_IDCITEM	*	gpEventListSearchCb0Tables[]	=	{  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,   CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table0,  CONST_zjgaEventListSearchCb0Table1,  NULL,	};
#endif  __HZSJ__
#ifdef  __OTHER__
		static  QY_IDCITEM	*	gpPcListSearchCb0Tables[]		=	{	NULL,   };
		static  QY_IDCITEM	*	gpEventListSearchCb0Tables[]	=	{	NULL,	};
#endif  __OTHER__
static  QY_IDCITEM	*	gpEventListSearchCb1Tables[]			=	{	NULL,	};

static  QY_IDCITEM		*	gpNetDevEventListSearchTable0		=	CONST_zjgaNetDevEventListSearchTable0;			//	查询网络事件列表的条件设置
static  QY_IDCITEM		*	gpNetDevEventListSearchCb0Tables[]	=	{	NULL,	};
static  QY_IDCITEM		*	gpNetDevEventListSearchCb1Tables[]	=	{	NULL,	};

static  QY_IDCITEM		*	gpOpEventListSearchTable0			=	CONST_zjgaOpEventListSearchTable0;					//	查询系统事件列表的条件设置
static  QY_IDCITEM		*	gpOpEventListSearchCb0Tables[]		=	{	NULL,	};
static  QY_IDCITEM		*	gpOpEventListSearchCb1Tables[]		=	{	NULL,	};

//  QY_IDCITEM		*	gpSecChkEventListSearchTable0		=	CONST_zjgaSecChkEventListSearchTable0;
static  QY_IDCITEM		*	gpSecChkEventListSearchCb0Tables[]	=	{	NULL,	};
static  QY_IDCITEM		*	gpSecChkEventListSearchCb1Tables[]	=	{	NULL,	};

//  统计
//	统计列表的条件设置
static  QY_IDCITEM	*	gpStatIpScanTable0				=	CONST_statIpScanTable0;
static  QY_IDCITEM	*	gpStatPcInfoTable0				=	CONST_zjgaStatPcInfoTable0;
static  QY_IDCITEM	*	gpStatPcInfoCb0Tables[]			=	{	CONST_zjgaStatPcInfoCb0Table0,  CONST_zjgaStatPcInfoCb0Table1,  NULL,	};
static  QY_IDCITEM	*	gpStatUsrInfoTable0				=	CONST_zjgaStatUsrInfoTable0;
static  QY_IDCITEM	*	gpStatUsrInfoCb0Tables[]		=	{	CONST_zjgaStatUsrInfoCb0Table0,  CONST_zjgaStatUsrInfoCb0Table1,  NULL,	};
static  QY_IDCITEM  *	gpStatGeneralTable0				=	CONST_zjgaStatGeneralTable0;
static  QY_IDCITEM	*	gpStatGeneralCb0Tables[]		=	{	CONST_zjgaStatGeneralCb0Table0,  CONST_zjgaStatGeneralCb0Table1,  NULL,	};
static  QY_IDCITEM  *	gpStatOthersTable0				=	CONST_zjgaStatOthersTable0;

//
static  QY_IDCITEM	*	gpStatMessengerInfoTable0		=	CONST_statMessengerInfoTable0;
static  QY_IDCITEM	*	gpStatMessengerInfoCb0Tables[]	=	{	CONST_statMessengerInfoCb0Table0,  CONST_statMessengerInfoCb0Table1,  NULL,	};
...
//  }  以上是的定制信息
 ...
 QY_DMITEM  CONST_searchTable_isCliHelp[]  =  
{
