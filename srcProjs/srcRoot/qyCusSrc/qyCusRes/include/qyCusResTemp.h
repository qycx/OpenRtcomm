...
#ifndef  __QYCUSRESTEMP_H__
#define  __QYCUSRESTEMP_H__		//  {
...
enum  enumResTemp
{
	...
	//
	CONST_resId_menu_audioStatus,
	CONST_resId_menu_videoStatus,
	CONST_resId_menu_fileStatus,
	//
	CONST_resId_menu_ioStatus,
	CONST_resId_menu_mgrStatus,
	//
	CONST_resId_menu_3dStatus,
	//
	CONST_resId_menu_decStatus,					//  2015/06/18
	CONST_resId_menu_playStatus,				//  2015/09/21
	//
	CONST_resId_menu_dlgTalkStatus,
	//  
...
//	CONST_resId_IDD_spProperties,
	...
	*/
	...
	//  CONST_resId_localVideo,				//	2021/08/13
	CONST_resId_startMeetingFirstly,	//	2021/05/26
	//
...
#if  0
	CONST_resId_peace,					//  peace
	CONST_resId_peace_short,			//  20161015,peace
#endif
	//  
	...
	CONST_resId_3dFont,		
	CONST_resId_vp8,					//  2021/05/26
	CONST_resId_mcuList,				//  2021/05/26
	//
	CONST_resId_avLevel_2160p,
...
#define		MACRO_popup_viewProcedObjs		\
	{	CONST_resId_popup_viewProcedObj_load,					0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_load,					},	\
	{	CONST_resId_popup_viewProcedObj_bhb,					0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_bhb,					},	\
	{	CONST_resId_popup_viewProcedObj_netMc2,					0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_netMc2,				},	\
	{	CONST_resId_popup_viewProcedObj_nms,					0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_nms,					},	\
	{	CONST_resId_popup_viewProcedObj_secChk,					0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_secChk,				},	\
	{	CONST_resId_popup_viewProcedObj_assetMgr,				0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_assetMgr,				},	\
	{	CONST_resId_popup_viewProcedObj_misClient,				0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_misClient,				},	\
	{	CONST_resId_popup_viewProcedObj_misMgr,					0,		(  TCHAR  *  )CONST_popupMenuTable_viewProcedObj_misMgr,				},




extern  QY_DMITEM		CONST_nullTable[];
extern  QY_DMITEM		CONST_strTable_netMc[];
extern  QY_DMITEM		CONST_strTable_isMgr[];
//extern  QY_DMITEM		CONST_strTable_isCli[];
extern  QY_DMITEM		CONST_strTable_isCli_noMfc[];
extern  QY_DMITEM		CONST_strTable_ts[];
extern  QY_DMITEM		CONST_popupMenuTable_netMc[];
extern  QY_DMITEM	*	CONST_popupMenuTable_mis;
extern  QY_DMITEM		CONST_popupMenuTable_mis_ts[];

extern  QY_DMITEM		CONST_dlgTable[];
extern  QY_DMITEM		CONST_dlgTable_isCli[];
extern  QY_DMITEM		CONST_dlgTable_ts[];
extern  QY_DMITEM		CONST_queryTable[];
extern  QY_DMITEM	*	CONST_queryTable_mis;		//  为了暂时能够在一个系统中察看所有的菜单，现将所有的query都放到CONST_queryTable中。等回头再分开。2007/06/19
extern  QY_DMITEM		CONST_searchTable[];
extern  QY_DMITEM		CONST_searchTable_isCliHelp[];

extern  QY_DMITEM		CONST_columnInfoTable[];

extern  QY_DMITEM		CONST_popupMenuTable_0[];
extern  QY_DMITEM		CONST_popupMenuTable_isCli[];		//  2012/07/22

extern  QY_DMITEM		CONST_menuTable_bangZhu[];

extern  QY_DMITEM		CONST_qnmEventTypeTable0_netMc[];
extern  QY_DMITEM		CONST_qnmEventTypeTable0_is[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_op_netMc[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_op_is[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_netMc2[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_nms[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_nmsNetDev[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_secChk[];
extern  QY_DMITEM		CONST_secChkEventTypeTable_qwm[];
extern  QY_DMITEM		CONST_secChkEventTypeTable_secChk[];
extern  QY_DMITEM		CONST_secChkEventTypeTable_netMc2[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_assetMgr[];
extern  QY_DMITEM		CONST_qnmEventTypeTable_misMgr[];
//  extern  QY_DMITEM		CONST_qnmEventTypeTable_null[];
